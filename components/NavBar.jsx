...
const Logo = tw.div`flex w-max justify-center items-end gap-3 text-2xl font-exo font-bold`;

const LogoText = tw.h1`hidden sm:block`

const Navs = tw.nav`flex  justify-between items-center gap-6 font-medium`;

const Route = tw.p`cursor-pointer  transition font-medium hover:text-purple-700 focus:outline-none`;
